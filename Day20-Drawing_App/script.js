...
eraseEl.addEventListener("click", () => {
    ...
    if (isErasing) {
        eraseEl.style.backgroundColor = "lightgray";
        eraseEl.style.border = "1px solid #aaa";
    } else {
        eraseEl.style.backgroundColor = "#fff";
        eraseEl.style.border = "none";
    }
});
